...
<br>We are currently focused on providing **verified onchain revenue data** for DePINs. In the future, we will add other verified metrics such as active nodes, network traffic and utilization rates. 
